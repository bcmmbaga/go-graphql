...
func (ec *executionContext) _Query_meeutps(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMeetup2ᚕᚖgithubᚗcomᚋbcmmbagaᚋgoᚑgraphqlᚋmodelsᚐMeetupᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNMeetup2ᚕᚖgithubᚗcomᚋbcmmbagaᚋgoᚑgraphqlᚋmodelsᚐMeetupᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Meetup) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMeetup2ᚖgithubᚗcomᚋbcmmbagaᚋgoᚑgraphqlᚋmodelsᚐMeetup(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMeetup2ᚖgithubᚗcomᚋbcmmbagaᚋgoᚑgraphqlᚋmodelsᚐMeetup(ctx context.Context, sel ast.SelectionSet, v *models.Meetup) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalNUser2githubᚗcomᚋbcmmbagaᚋgoᚑgraphqlᚋmodelsᚐUser(ctx context.Context, sel ast.SelectionSet, v models.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚖgithubᚗcomᚋbcmmbagaᚋgoᚑgraphqlᚋmodelsᚐUser(ctx context.Context, sel ast.SelectionSet, v *models.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
